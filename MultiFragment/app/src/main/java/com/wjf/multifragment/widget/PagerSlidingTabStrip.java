package com.wjf.multifragment.widget;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF9B9B9B;
    private int selectedTabTextColor = 0xFF9B9B9B;
    private Typeface tabTypeface = null;
    private int tabTypefaceStyle = Typeface.NORMAL;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.bg_pager_sliding_tab_default;
...
//                    tab.getPaint().setFakeBoldText(true);
                    tab.getPaint().setFakeBoldText(false); // 模仿虎嗅的风格，这里不加粗也不变大
                }
            }
        }
